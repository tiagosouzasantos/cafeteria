...
<head>
    ...
    <title>Contato - Cafe Gourmet</title>
...
<body>
    ...
    <div class="container text-center">
        ...
        <p style="font-size: 13px;">Aluno: Tiago de Souza Santos</p>
        <p style="font-size: 13px;">E-mail: t.santos86@cs.unicid.edu.br</p>
        <p style="font-size: 13px;">RGM: 35631830</p>
